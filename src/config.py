...
MACHSUITE_KERNEL = ['gemm-blocked', 'aes', 'gemm-ncubed', 'spmv-crs', 'spmv-ellpack', 'stencil_stencil2d',
                    'nw', 'md', 'stencil-3d']
...
#custom_KERNEL = ['optical-flow', 'atax', 'canny-edge', 'harris-corner', 'jacobi', 'cnn']
# custom_KERNEL = ['optical-flow', 'canny-edge', 'harris-corner', 'jacobi', 'cnn']
custom_KERNEL = ['optical-flow'] #TODO troubleshoot why this isn't workign for other kernes
# custom_KERNEL = ['cnn']
...
dataset = 'harp' # machsuite and poly AND custom
parser.add_argument('--dataset', default=dataset)

benchmark = ['custom'] #['machsuite', 'poly']
